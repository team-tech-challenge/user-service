...
describe('Server Initialization', () => {
    ...
    beforeAll(() => {
        process.env.PORT = '3001'; // Set the environment variables for testing
        process.env.HOST = 'user-service';
    ...
    it('should start the server and call newman', async () => {
        ...
        expect(consoleLogSpy).toHaveBeenCalledWith('Server running on 3001'); // Check if the server log is correct
